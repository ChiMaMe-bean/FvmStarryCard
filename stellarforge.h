#ifndef STELLARFORGE_H
#define STELLARFORGE_H
...
QT_BEGIN_NAMESPACE
namespace Ui { class StellarForge; }
QT_END_NAMESPACE
...
class StellarForge : public QMainWindow
{
    Q_OBJECT

public:
    StellarForge(QWidget *parent = nullptr);
    ~StellarForge();
